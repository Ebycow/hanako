...
## System Dependencies
* **C++ Build Tools**:
  * Linux: gcc, g++, make, build-essential
  * Windows: Visual Studio Build Tools
  * macOS: Xcode Command Line Tools
* **CMake**: Native module compilation用 >= 3.5
* **libsamplerate**: 高品質オーディオサンプリングレート変換
...
* **Ebyroid Audio Server** (推奨):
  ...
  * 有効なVoiceroidライセンス
  * デフォルトポート: 4090
* または `GET /api/v1/audiofile?text=&name=` でaudio/wavを返すHTTP APIサーバ

## Special Dependencies
* **node-libsamplerate**: ローカルカスタム依存関係 (`../node-libsamplerate`)
